...
const RiderMapTracking = ({ originCoordinates, destinationCoordinates }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        {originCoordinates.lat && (
          <Marker position={originCoordinates} label="My current location" />
        )}
        {destinationCoordinates.lat && (
...
export default RiderMapTracking;
