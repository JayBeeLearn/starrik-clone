...
const CompReg = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        const requiredFields = [
            ...
            { field: compAdminAddress, label: "Company Name" },
            { field: compAccountName, label: "Company Name" },
            { field: compAdminRole, label: "Company Name" },
            { field: compAccountType, label: "Company Name" },
