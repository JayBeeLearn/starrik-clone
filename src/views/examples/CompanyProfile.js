...
import { getAuth, onAuthStateChanged, signOut, reauthenticateWithCredential, EmailAuthProvider, updatePassword } from "firebase/auth";
...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const userDocRef = doc(db, "independentriders", userdetails.id); 
